import importlib, re
from Tokisaki import dispatcher, ALLOW_EXCL, LOGGER
from telegram import InlineKeyboardButton, InlineKeyboardMarkup, ParseMode, Update
from Tokisaki.Handlers.misc import paginate_modules
