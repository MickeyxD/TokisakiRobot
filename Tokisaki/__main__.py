...
from Tokisaki.Plugins import ALL_MODULES
from Tokisaki.__help__ import (
get_help, 
help_button, 
get_settings, 
settings_button, 
...
def start(update: Update, context: CallbackContext):
    ...
    [
        ...
        InlineKeyboardButton(
            text="Bot Info", callback_data="Tokisaki_"
        ),
    ],
    [
...
def Tokisaki_about_callback(update: Update, context: CallbackContext):
    first_name = update.effective_user.first_name
    query = update.callback_query
    if query.data == "Tokisaki_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                   [
                     InlineKeyboardButton(text="Support", url="t.me/Tokisaki_Support"),
                     InlineKeyboardButton(text="News", url="t.me/Tokisaki_Updates"),
                   ],
                   [
                    InlineKeyboardButton(text="Back", callback_data="Tokisaki_back")
                   ]
                ]
            ),
        )
    elif query.data == "Tokisaki_back":
        query.message.edit_text(
                PM_START_TEXT.format(
                        escape_markdown(first_name), escape_markdown(context.bot.first_name)),
                reply_markup=InlineKeyboardMarkup([
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(Tokisaki_about_callback, pattern=r"Tokisaki_", run_async=True)
